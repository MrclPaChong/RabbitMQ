...
public class TopicConsumer2 {
    ...
    //队列名字
    private static final String PRODUCER_NAME = "EXCHANGE_TOPIC_RABBIT2";
    ...
    public static void main(String[] args) throws Exception{
        ...
        channel.queueBind(PRODUCER_NAME,EXCHANGE_NAME,"key.#");
        //如果接收多个标记只需要在接收一次key
        channel.queueBind(PRODUCER_NAME,EXCHANGE_NAME,"abc.#");
        ...
        Consumer consumer = new DefaultConsumer(channel) {
            ...
            public void handleDelivery(String consumerTag, Envelope envelope,
                ...
                //打印获取的消息
                System.out.println("*********** TOPICConsumer1" + " get message :[" + msg +"]");

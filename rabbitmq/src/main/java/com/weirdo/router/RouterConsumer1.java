 ...
 * publish模式:消费者
 */
public class RouterConsumer1 {

    //定义一个交换机名字
    private  final  static String EXCHANGE_NAME = "EXCHANGE_ROUTER_NAME";

    //队列名字
    private static final String PRODUCER_NAME = "EXCHANGE_ROUTER_RABBIT1";
    ...
    public static void main(String[] args) throws Exception{
        ...
        //如果接收多个标记只需要在接收一次key
        channel.queueBind(PRODUCER_NAME,EXCHANGE_NAME,"key2");
        ...
        Consumer consumer = new DefaultConsumer(channel) {
            ...
            public void handleDelivery(String consumerTag, Envelope envelope,
                ...
                //打印获取的消息
                System.out.println("*********** RouterConsumer1" + " get message :[" + msg +"]");

...
public class HelloProducer {
    ...
    //队列名字
    private static final String PRODUCER_NAME = "HELLO_RABBITMQ";
    ...
    public static void main(String[] args) throws Exception{
        ...
        //发送内容
        String mes = "helloWord";
        channel.basicPublish("",PRODUCER_NAME,null,mes.getBytes());

        //打印日志
        log.info("发送时间："+new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date()));
        log.info("发送内容："+mes);
        //关闭连接
        channel.close();
        connection.close();
